---
name: to-tasks
description: Breaks architecture into ordered tasks. Use when you have architecture docs and need to break work into implementable tasks. Use when a task feels too large to start, when you need to estimate scope, or when parallel work is possible.
---
